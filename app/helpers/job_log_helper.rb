module JobLogHelper
    ...
    def logs_to_excel entries, document
        ...
        wb.styles do |s|
            title_cell = s.add_style :bg_color => "FF", :fg_color => "00", :b => true, :sz => 20, :alignment => {:horizontal => :center}
            title_cell2 = s.add_style :bg_color => "FF", :fg_color => "00", :b => true, :sz => 14, :alignment => {:horizontal => :center}
            column_name_cell = s.add_style :bg_color => "00", :fg_color => "FF", :sz => 14, :alignment => {:horizontal => :left}, :border => { :style => :thin, :color =>"00", :edges => [:top, :bottom] }

            cell1 = s.add_style :bg_color => "ddf9fe", :fg_color => "00", :b => true, :sz => 12
            cell2 = s.add_style :bg_color => "9decfa", :fg_color => "00", :b => true, :sz => 12
            ...
            wb.add_worksheet(:name => "Job Log", :page_margins => margins, :page_setup => setup, :print_options => options) do |sheet|
                ...
                sheet.column_widths 12, 10, 100, 15
