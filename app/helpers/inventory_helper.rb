module InventoryHelper
    ...
    def parts_to_excel parts
        ...
        wb.styles do |s|
            ...
            cell1_available = s.add_style :bg_color => "dbe6f1",:fg_color => "2fad1e", :b => true, :sz => 13, :alignment => {:horizontal => :left}
            cell1_on_job = s.add_style  :bg_color => "dbe6f1",:fg_color => "0058a8", :b => true, :sz => 13, :alignment => {:horizontal => :left}
            cell1_in_redress = s.add_style  :bg_color => "dbe6f1",:fg_color => "c71a1a", :b => true, :sz => 13, :alignment => {:horizontal => :left}
            cell2_available = s.add_style :bg_color => "b9cce4",:fg_color => "2fad1e", :b => true, :sz => 13, :alignment => {:horizontal => :left}
            cell2_on_job = s.add_style  :bg_color => "b9cce4",:fg_color => "0058a8", :b => true, :sz => 13, :alignment => {:horizontal => :left}
            cell2_in_redress = s.add_style  :bg_color => "b9cce4",:fg_color => "c71a1a", :b => true, :sz => 13, :alignment => {:horizontal => :left}
